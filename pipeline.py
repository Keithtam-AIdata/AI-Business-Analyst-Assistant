...
def interpret_result(question: str, sql: str, df, client, model: str = "gpt-5-mini") -> str:
    ...
    prompt = (
        ...
        "4. Plain text only — no markdown. Never use backticks, asterisks, or code\n"
        "   formatting. Write '$' as an ordinary currency symbol directly (e.g. $11.58\n"
        "   or $1 of spend); never wrap numbers, currency, or anything else in backticks\n"
        "   or quotes. Every number and field appears as ordinary prose.\n\n"
